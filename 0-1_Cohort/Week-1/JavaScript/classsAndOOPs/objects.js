//Prototypes gives- classes, this keyword,arrow function,prototypal inherritence
...
console.log(multipleBy5.power)// function is a object also
...
const userOne=new createUser("isha",25)
const userTwo=new createUser("mahi",45)//new keyword also helps in readinmg extra properties in prototype added by us

userOne.printMe()  //userOne.prototype.printMe()
